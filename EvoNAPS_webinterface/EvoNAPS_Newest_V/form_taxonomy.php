  ...
  <div class ="center">
	...
	<form action="results_alignment.php" method="post" class="was-validated" onsubmit="updateFormVal()">
		...
		<fieldset  class="text_form" id="id_search_field" style= "display:none;">
			...
			<div class="formfield">
				<label for="Ali_ID" title="IDs should be separated by a comma and one whitespace"> Alignment ID: </label> 
				<textarea type="text" name="Alignment_ID" id="Ali_ID" class="text_field_id" wrap="soft" placeholder="IDs should be separated by a comma and one whitespace"></textarea>
		...
		<fieldset  class="text_form" id="ranks_search_field" style= "display:none;">
			...
			<input class ="cb" type="checkbox" name="OrthoMaM_v10c"  id="OrthoMaM_v10c_rank"  value="OrthoMaM" onchange = "checkkallAli('rank')">
		...
		<div>
		<input type="button" class= "search_option" value="Searching for alignments with a specific LCA or ancestor" name="clade_search_btn" onclick="AliSearchOptions('clade_search_field', 'clade_search')" id="specific_ali">
			
		</div>

		<fieldset  class="text_form" id="clade_search_field" style= "display:none;">
			<br>
			<input type="radio" name="clade_search"  id="clade_search" value="TRUE" style="display: none;">
			<label for="Rank"> Taxon:</label> 
			...
			<span> Alignments source: </span>
		   	<br>
		   	<input class ="cb" type="checkbox" name="all_sources"  id="all_clade" onchange = "checkkallAli('clade')" value="checked" checked style='margin-left:-2px;'>
		   	<label for = "all"> all </label> 
		   	<input class ="cb" type="checkbox" name="Lanfear"  id="Lanfear_clade"  value="Lanfear" onchange = "checkkallAli('clade')">
		   	<label for = "Lanfear"> Lanfear </label> 
		   	<input class ="cb" type="checkbox" name="OrthoMaM_v10c"  id="OrthoMaM_v10c_clade"  value="OrthoMaM" onchange = "checkkallAli('clade')">
		   	<label for = "OrthoMaM"> OrthoMaM v10c</label>
			<input class ="cb" type="checkbox" name="OrthoMaM_v12a"  id="OrthoMaM_v12a_clade"  value="OrthoMaM_v12a" onchange = "checkkallAli('calde')">
			<label for = "OrthoMaM"> OrthoMaM v12a</label>
			...
			<br>
			<label for="max number of hits" class="ex1"> Max number of alignments:</label>
		 	<input type="number" class="rank_form" name="number_of_hits_clade" id="Nr_hits_clade" step="any" min="0" max="200">
		...
		<fieldset  class="text_form" id="sp_taxa_search_field" style= "display:none;">
			...
			<label for="TaxaID">  Taxon ID 1: </label> 
        	<input type="text" name="Taxa_ID" id="TaxaID" class="text_field">
			<label class="suggestion" for="TaxaID">(recommended species level)</label>
			<br> 
			<label for="TaxaID">  Taxon ID 2: </label> 
        	<input type="text" name="Taxa_ID" id="TaxaID2" class="text_field">
			<br> 
			<label for="TaxaID">  Taxon ID 3: </label> 
        	<input type="text" name="Taxa_ID" id="TaxaID3" class="text_field">
			<br> 
			<label for="TaxaID">  Taxon ID 4: </label> 
        	<input type="text" name="Taxa_ID" id="TaxaID3" class="text_field">
			<br> 
			<label for="TaxaID">  Taxon ID 5: </label> 
        	<input type="text" name="Taxa_ID" id="TaxaID3" class="text_field">
			<br> 
			<br>
			<label for="Rank"> Rank of LCA: &emsp;&emsp;</label> 
        	<!-- <input type="text" name="rank" id="Rank" placeholder="class" > -->
			...
			<br>
		   	...
		   	<label for = "Lanfear">Lanfear </label> 
		   	<input class ="cb" type="checkbox" name="OrthoMaM_v10c"  id="OrthoMaM_v10c_taxa"  value="OrthoMaM" onchange = "checkkallAli('taxa')">
		   	<label for = "OrthoMaM"> OrthoMaM V10c </label>
			...
			<label for="max number of hits" class="ex1"> Max number of alignments:</label>
		 	<input type="number" class="rank_form" name="number_of_hits_taxa" id="Nr_hits_taxa" step="any" min="0" max="200">
