...
<html lang="en" dir="ltr">
  ...
  <div class ="center">
	...
	<form action="results_alignment.php" method="post" class="was-validated" onsubmit="updateFormVal()">
		...
		<fieldset  class="text_form" id="id_search_field" <?php echo (!empty($_SESSION['id_search'])) ? "style='display : block;'" : "style='display : none;'";?>>
			<br>
			<input type="radio" name="id_search"  id="id_search" value="TRUE" style="display: none;" <?php if(!empty($_SESSION['id_search'])){ echo "checked"; } ?>>
			...
			<textarea type="text" name="Alignment_ID" id="Ali_ID" class="text_field_id" wrap="soft" placeholder="IDs should be separated by a comma and a whitespace"><?php if(!empty($_SESSION['Alignment_ID'])){ echo $_SESSION['Alignment_ID'];} ?></textarea>
		...
		<div>
			<input type="button" class= "search_option" value="Searching for alignments within certain ranks" name="ranks_search_btn" onclick="AliSearchOptions('ranks_search_field', 'rank_search')" id="specific_ali">
			
		</div>
		<fieldset  class="text_form" id="ranks_search_field" <?php echo (!empty($_SESSION['rank_search'])) ? "style = 'display : block;'" : "style = 'display : none;'";?>> 
			<br>
			<input type="radio" name="rank_search"  id="rank_search" value="TRUE" style="display: none;" <?php if(!empty($_SESSION['rank_search'])){ echo "checked"; } ?>>
		    ...
		    <br>
		   	<input class ="cb" type="checkbox" name="all_sources"  id="all_rank" onchange = "checkkallAli('rank')"  style='margin-left:-2px;' <?php if(isset($_SESSION['all_sources'])){ echo "checked"; }?>>
			...
			<input class ="cb" type="checkbox" name="OrthoMaM_v10c"  id="OrthoMaM_v10c_rank"  value="OrthoMaM" onchange = "checkkallAli('rank')" <?php if(isset($_SESSION['OrthoMaM_v10c'])){ echo "checked"; }?>>
			<label for = "OrthoMaM"> OrthoMaM v10c</label>
			<input class ="cb" type="checkbox" name="OrthoMaM_v12a"  id="OrthoMaM_v12a_rank"  value="OrthoMaM_v12a" onchange = "checkkallAli('rank')" <?php if(isset($_SESSION['OrthoMaM_v12a'])){ echo "checked"; }?>>
		...
		<div>
		<input type="button" class= "search_option" value="Searching for alignments within certain clade" name="clade_search_btn" onclick="AliSearchOptions('clade_search_field', 'clade_search')" id="specific_ali">
			
		</div>
		<fieldset  class="text_form" id="clade_search_field" <?php echo (!empty($_SESSION['clade_search'])) ? "style = 'display : block';" :  "style = 'display : none;'";?>>
			<br>
			<input type="radio" name="clade_search"  id="clade_search" value="TRUE" style="display: none;" <?php if(!empty($_SESSION['clade_search'])){ echo "checked"; } ?>>
			...
			<span> Alignments source: </span>
		   	<br>
		   	<input class ="cb" type="checkbox" name="all_sources"  id="all_clade" onchange = "checkkallAli('clade')" value="checked"  style='margin-left:-2px;' <?php if(isset($_SESSION['all_sources'])){ echo "checked"; }?>>
		   	<label for = "all"> all </label> 
		   	...
		   	<label for = "Lanfear"> Lanfear </label> 
		   	<input class ="cb" type="checkbox" name="OrthoMaM_v10c"  id="OrthoMaM_clade_v10c"  value="OrthoMaM" onchange = "checkkallAli('clade')" <?php if(isset($_SESSION['OrthoMaM_v10c'])){ echo "checked"; }?>>
		   	<label for = "OrthoMaM"> OrthoMaM v10c </label>
			<input class ="cb" type="checkbox" name="OrthoMaM_v12a"  id="OrthoMaM_v12a_clade"  value="OrthoMaM_v12a" onchange = "checkkallAli('calde')"<?php if(isset($_SESSION['OrthoMaM_v12a'])){ echo "checked"; }?>>
			<label for = "OrthoMaM"> OrthoMaM v12a</label>
		...
		<fieldset  class="text_form" id="sp_taxa_search_field" <?php echo (!empty($_SESSION['taxa_search'])) ? "style = 'display : block';" : "style = 'display : none';"; ?>>
			<br>
			<input type="radio" name="taxa_search"  id="taxa_search" value="TRUE" style="display: none;" <?php if(!empty($_SESSION['taxa_search'])){ echo "checked"; } ?>>
			...
			<br>
		   	<input class ="cb" type="checkbox" name="all_sources"  id="all_taxa" onchange = "checkkallAli('taxa')" value="checked" style='margin-left:-1px;' <?php if(isset($_SESSION['all_sources'])){ echo "checked"; }?>>
		   	<label for = "all">all </label> 
		   	...
		   	<label for = "Lanfear">Lanfear </label> 
		   	<input class ="cb" type="checkbox" name="OrthoMaM_v10c"  id="OrthoMaM_v10c_taxa"  value="OrthoMaM" onchange = "checkkallAli('taxa')" <?php if(isset($_SESSION['OrthoMaM_v10c'])){ echo "checked"; }?>>
		   	<label for = "OrthoMaM"> OrthoMaM V10c </label>
			<input class ="cb" type="checkbox" name="OrthoMaM_v12a"  id="OrthoMaM_v12a_taxa"  value="OrthoMaM_v12a" onchange = "checkkallAli('taxa')"<?php if(isset($_SESSION['OrthoMaM_v12a'])){ echo "checked"; }?>>
		   	<label for = "OrthoMaM"> OrthoMaM V12a</label>
