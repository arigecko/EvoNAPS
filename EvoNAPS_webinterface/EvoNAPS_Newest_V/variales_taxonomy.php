...
$_SESSION = array();
		...
		if(isset($_POST['Alignment_ID'])){
			...
			foreach ($Ali_ID as $id){
				echo $id;
				echo "<br>";*/
			$Ali_ID_arr =  $_POST['Alignment_ID'];
			$_SESSION['Alignment_ID']= $Ali_ID_arr;
			}
		...
		if(isset($_POST['rank_search'])){
			...
			$_SESSION['rank_search']= $Rank_search; 
...
/*
		...
		if(isset($_POST['clade_search'])){
			$Clade_search = $_POST['clade_search'];
			$_SESSION['clade_search']= $Clade_search; 
		...
		if(isset($_POST['taxa_search'])){
			...
			$_SESSION['taxa_search']= $Taxa_search; 
		...
		/*echo (!empty($_SESSION['id_search_radio'])) ? "Id search" : "no Id search";
		echo "<br>";
		if (!isset($Rank_search)){echo "No rank search";};
		//echo (isset($Rank_search) AND !empty($_SESSION['rank_search_radio'])) ? "Rank search" :  "no Rank search";;
		echo (!empty($_SESSION['rank_search_radio'])) ? "Rank search" :  "no Rank search";;
		echo "<br>";
		//echo (isset($Clade_search) AND !empty($_SESSION['clade_search_radio'])) ? "Clade search" :  "no Clade search";;
		echo (!empty($_SESSION['clade_search_radio'])) ? "Clade search" :  "no Clade search";;
		echo "<br>";
		echo (!empty($_SESSION['taxa_search_radio'])) ? "Taxa search" : "no taxa search";
		echo "<br>"; */
